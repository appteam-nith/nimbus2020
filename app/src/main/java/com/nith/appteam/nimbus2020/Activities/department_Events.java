...
public class department_Events extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedPref.getString("phoneNumber", "").equals("+919340453051") || sharedPref.getString("phoneNumber", "").equals("+918572027705")|| sharedPref.getString("phoneNumber", "").equals("+918219387794")) {
