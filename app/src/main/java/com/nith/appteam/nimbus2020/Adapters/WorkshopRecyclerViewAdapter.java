...
public class WorkshopRecyclerViewAdapter extends
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.with(context).load(imageLinkWor).placeholder(
                android.R.drawable.ic_btn_speak_now).into(holder.imgSpkrWork);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView nameWor, dateWor, infoWor, regUrlWor, venueWor, typeWor;
